<?php
/**
 * Admin Panel - İletişim Bilgileri Ayarları
 * İletişim sayfası bilgilerini ve sosyal medya linklerini yönetme sayfası
 */
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Çalışma Saatleri 1</label>
                                    <input type="text" 
                                           name="working_hours1" 
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Çalışma Saatleri 2</label>
                                    <input type="text" 
                                           name="working_hours2" 
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Harita Embed Kodu (Google Maps)</label>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-blue-800">
                                        Footer'daki iletişim bilgileri (adres, telefon, e-posta) "İletişim Bilgileri" sekmesindeki verilerle otomatik olarak senkronize edilir. 
