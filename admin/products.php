...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between text-sm text-gray-600">
        ...
        <div>
            Sayfa <span class="font-semibold"><?= $page ?></span> / <span
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <form method="POST" class="inline-block"
                                        ...
                                        <button type="submit"
                                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium transition-colors <?= $product['is_featured'] ? 'bg-yellow-100 text-yellow-800 hover:bg-yellow-200' : 'bg-gray-100 text-gray-800 hover:bg-gray-200' ?>">
                ...
                <div class="px-6 py-4 border-t border-gray-100">
                    <nav class="flex items-center justify-between">
                        <div class="text-sm text-gray-700">
                            ...
                            <span class="font-semibold"><?= $offset + 1 ?></span> - <span
                                class="font-semibold"><?= min($offset + $limit, $total_products) ?></span> arası gösteriliyor
                        </div>
                        <div class="flex items-center space-x-2">
                            <?php if ($page > 1): ?>
                                <a href="javascript:void(0)"
                                    class="px-3 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors pagination-link"
                                    data-page="<?= $page - 1 ?>">
                            ...
                            for ($i = $start_page; $i <= $end_page; $i++):
                                ...
                                ?>
                                <a href="javascript:void(0)"
                                    class="px-3 py-2 rounded-lg transition-colors pagination-link <?= $is_current ? 'bg-primary-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' ?>"
                                    data-page="<?= $i ?>">
                                    <?= $i ?>
                                </a>
                            <?php endfor; ?>
