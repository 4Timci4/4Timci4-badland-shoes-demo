 ...
 * 
 * Yeni admin kullanıcısı ekleme formu
 */
        ...
        <?php if ($success): ?>
            <div class="mb-6">
                ...
                <div class="mt-4 flex space-x-3">
                    <a href="admins.php" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium transition-colors">
                        Admin Listesine Dön
                    </a>
                    <a href="admin-add.php" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg font-medium transition-colors">
                        Başka Admin Ekle
                    </a>
                </div>
            </div>
