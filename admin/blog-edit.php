    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
        <div>
            ...
            <p class="text-gray-600">
                <span class="font-semibold"><?= htmlspecialchars($blog['title']) ?></span> yazısının bilgilerini
                güncelleyin
            </p>
        </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <select id="category" name="category" required
                                ...
                                <option value="Trendler" <?= ($blog['category'] ?? '') === 'Trendler' ? 'selected' : '' ?>>
                                    Trendler</option>
                                <option value="Sağlık" <?= ($blog['category'] ?? '') === 'Sağlık' ? 'selected' : '' ?>>
                                    Sağlık</option>
                                <option value="Moda" <?= ($blog['category'] ?? '') === 'Moda' ? 'selected' : '' ?>>Moda
                                </option>
                                <option value="Bakım" <?= ($blog['category'] ?? '') === 'Bakım' ? 'selected' : '' ?>>Bakım
                                </option>
                                <option value="Teknoloji" <?= ($blog['category'] ?? '') === 'Teknoloji' ? 'selected' : '' ?>>Teknoloji</option>
                                <option value="Yaşam" <?= ($blog['category'] ?? '') === 'Yaşam' ? 'selected' : '' ?>>Yaşam
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="p-6">
                        ...
                        <div id="image-preview" class="mt-4 <?= empty($blog['image_url']) ? 'hidden' : '' ?>">
                            <div class="border border-gray-200 rounded-xl overflow-hidden">
                                <img id="preview-img" src="<?= htmlspecialchars($blog['image_url'] ?? '') ?>"
                                    alt="Önizleme" class="w-full h-32 object-cover">
                            </div>
                        </div>
                    </div>
                </div>
