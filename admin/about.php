 ...
 * Modern, kullanıcı dostu hakkımızda sayfası yönetim paneli
 */
...
<div class="space-y-6">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
        ...
        <div class="mt-4 lg:mt-0 flex space-x-3">
            <a href="../about.php" target="_blank" class="inline-flex items-center px-6 py-3 bg-green-100 text-green-700 font-semibold rounded-xl hover:bg-green-200 transition-colors">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="border-b border-gray-100">
            <nav class="flex space-x-0">
                <button class="tab-button px-6 py-4 text-sm font-semibold border-b-2 transition-colors <?= $active_tab === 'general' ? 'border-primary-500 text-primary-600 bg-primary-50' : 'border-transparent text-gray-500 hover:text-gray-700 hover:bg-gray-50' ?>"
                        data-tab="general">
                    <i class="fas fa-cog mr-2"></i>
                    Genel Ayarlar
                </button>
                <button class="tab-button px-6 py-4 text-sm font-semibold border-b-2 transition-colors <?= $active_tab === 'values' ? 'border-primary-500 text-primary-600 bg-primary-50' : 'border-transparent text-gray-500 hover:text-gray-700 hover:bg-gray-50' ?>"
                        data-tab="values">
                    <i class="fas fa-star mr-2"></i>
                    Değerlerimiz
                </button>
                <button class="tab-button px-6 py-4 text-sm font-semibold border-b-2 transition-colors <?= $active_tab === 'team' ? 'border-primary-500 text-primary-600 bg-primary-50' : 'border-transparent text-gray-500 hover:text-gray-700 hover:bg-gray-50' ?>"
                        data-tab="team">
            ...
            <div id="general-tab" class="tab-content <?= $active_tab !== 'general' ? 'hidden' : '' ?>">
                <form method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            <h3 class="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Bölüm Başlıkları</h3>
                                ...
                                <div class="content-block-item bg-gray-50 border border-gray-200 rounded-xl p-4 hover:bg-gray-100 transition-colors cursor-move"
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <h4 class="font-bold text-gray-900 mb-1"><?= htmlspecialchars($value['title']) ?></h4>
                                            <p class="text-gray-600 text-sm line-clamp-2"><?= htmlspecialchars($value['content']) ?></p>
                                        ...
                                        <div class="flex-shrink-0 flex space-x-2">
                                            ...
                                            <form method="POST" class="inline-block" onsubmit="return confirm('Bu değeri silmek istediğinizden emin misiniz?')">
                                                <input type="hidden" name="csrf_token" value="<?= generate_csrf_token() ?>">
                            ...
                            <?php foreach ($team as $member): ?>
                                <div class="content-block-item bg-gray-50 border border-gray-200 rounded-xl p-4 hover:bg-gray-100 transition-colors cursor-move"
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <!-- Content -->
                                        <div class="flex-1 min-w-0">
                                            <h4 class="font-bold text-gray-900 mb-1"><?= htmlspecialchars($member['title']) ?></h4>
                                            <p class="text-primary-600 font-semibold text-sm mb-1"><?= htmlspecialchars($member['subtitle']) ?></p>
                                            <p class="text-gray-600 text-sm line-clamp-2"><?= htmlspecialchars($member['content']) ?></p>
                                        ...
                                        <div class="flex-shrink-0 flex space-x-2">
                                            ...
                                            <form method="POST" class="inline-block" onsubmit="return confirm('Bu ekip üyesini silmek istediğinizden emin misiniz?')">
                                                <input type="hidden" name="csrf_token" value="<?= generate_csrf_token() ?>">
                                                <input type="hidden" name="action" value="delete_content_block">
