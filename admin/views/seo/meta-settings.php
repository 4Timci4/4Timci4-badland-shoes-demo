            ...
            <div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="default_title"
                    ...
                    <div>
                        ...
                        <input type="text" name="title_separator"
                            ...
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                        <p class="text-sm text-gray-500 mt-1">Sayfa title'ı ile site adı arasında kullanılacak ayırıcı
                            (örn: " | ")</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Arama motorlarında görünecek site açıklaması (maksimum 160
                            karakter)</p>
                    </div>
