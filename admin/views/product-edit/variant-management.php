    ...
    <div class="p-6 space-y-6">
        ...
        <div class="space-y-4">
            ...
            <div class="hidden lg:block overflow-hidden border border-gray-200 rounded-xl">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50" data-variant-id="<?= $variant['id'] ?>" data-color-id="<?= $variant['color_id'] ?? '' ?>">
            ...
            <div class="lg:hidden space-y-4">
                ...
                $imageCount = count($colorImages);
                ?>
                <div class="bg-white border border-gray-200 rounded-xl p-4 space-y-4" data-variant-id="<?= $variant['id'] ?>" data-color-id="<?= $colorId ?>">
                    <!-- Header -->
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            <div class="w-8 h-8 rounded-full border border-gray-300"
                                 style="background-color: <?= htmlspecialchars($variant['color_hex'] ?? '#cccccc') ?>"></div>
                            <div>
                                <h5 class="font-medium text-gray-900"><?= htmlspecialchars($variant['color_name'] ?? 'Renk Yok') ?></h5>
                                <p class="text-sm text-gray-500"><?= htmlspecialchars($variant['size_value'] ?? 'Beden Yok') ?> <?= htmlspecialchars($variant['size_type'] ?? '') ?></p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <button type="button"
                                    class="save-variant-btn text-green-600 hover:text-green-700 p-2"
                                    data-variant-id="<?= $variant['id'] ?>">
                                <i class="fas fa-save"></i>
                            </button>
                            <button type="button"
                                    class="delete-variant-btn text-red-600 hover:text-red-700 p-2"
                                    data-variant-id="<?= $variant['id'] ?>">
                                <i class="fas fa-trash"></i>
                            </button>
                        </div>
