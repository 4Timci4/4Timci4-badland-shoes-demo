<?php
/**
 * Yeni Slider Ekleme Sayfası
 * Modern, kullanıcı dostu slider ekleme formu
 */
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div id="slider-preview" class="relative h-64 rounded-xl overflow-hidden" style="background-color: #f0f0f0;">
                            ...
                            <div class="relative z-10 h-full flex items-center justify-center text-center text-white">
                                <div class="max-w-md px-4">
                                    <h2 id="preview-title" class="text-2xl md:text-3xl font-bold mb-3">Slider Başlığı</h2>
                                    <p id="preview-description" class="text-sm md:text-base mb-4">Slider açıklaması burada görünecek</p>
