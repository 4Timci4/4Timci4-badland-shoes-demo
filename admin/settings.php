                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="site_favicon"
            ...
            <form method="POST">
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Sayfa Başına Ürün
                                    Sayısı</label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Sayfa Başına Blog
                                    Sayısı</label>
                                <input type="number" name="blogs_per_page"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="timezone"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                    <option value="Europe/Istanbul" <?= ($technical_settings['timezone'] ?? 'Europe/Istanbul') === 'Europe/Istanbul' ? 'selected' : '' ?>>Europe/Istanbul
                                    </option>
                                    <option value="America/New_York" <?= ($technical_settings['timezone'] ?? 'Europe/Istanbul') === 'America/New_York' ? 'selected' : '' ?>>America/New_York
                                    </option>
