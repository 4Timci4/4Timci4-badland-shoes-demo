<?php
/**
 * Admin Yönetimi - Ana Sayfa
 * 
 * Tüm admin kullanıcılarını listeler ve yönetim işlemlerini sağlar
 */
...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-4">
                    <a href="admin-add.php" class="bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-lg font-medium flex items-center transition-colors">
        ...
        <?php if ($message): ?>
            <div class="mb-6">
                <div class="<?= $message_type === 'success' ? 'bg-green-50 border border-green-200 text-green-800' : 'bg-red-50 border border-red-200 text-red-800' ?> rounded-lg p-4 flex items-center">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-green-600"><?= count(array_filter($admins, fn($admin) => $admin['is_active'])) ?></p>
                    </div>
                </div>
            </div>
                        ...
                        <?php if (empty($admins)): ?>
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                    ...
                                    <p class="text-sm">İlk admin kullanıcısını oluşturmak için yukarıdaki butonu kullanın</p>
                                </td>
                            </tr>
                        <?php else: ?>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php if ($admin['last_login_at']): ?>
                                            <div class="flex flex-col">
                                                ...
                                                <span class="text-xs text-gray-500"><?= date('H:i', strtotime($admin['last_login_at'])) ?></span>
                                            </div>
                                        <?php else: ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-xs text-gray-500"><?= date('H:i', strtotime($admin['created_at'])) ?></span>
                                        </div>
                                    </td>
