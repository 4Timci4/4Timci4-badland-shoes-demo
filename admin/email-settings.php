                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="mail_host"
                                    value="<?= htmlspecialchars($email_settings['mail_host'] ?? '') ?>"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Port</label>
                                <input type="number" name="mail_port"
                                    value="<?= htmlspecialchars($email_settings['mail_port'] ?? '587') ?>"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                            </div>
                        </div>
                        <div>
                            ...
                            <input type="text" name="mail_username"
                                value="<?= htmlspecialchars($email_settings['mail_username'] ?? '') ?>"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Şifre</label>
                            <input type="password" name="mail_password"
                                value="<?= htmlspecialchars($email_settings['mail_password'] ?? '') ?>"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                        </div>
                        <div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="email" name="mail_from_address"
                                value="<?= htmlspecialchars($email_settings['mail_from_address'] ?? '') ?>"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                        </div>
                        <div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <form method="POST">
                ...
                <div class="p-6">
                    ...
                    <p class="text-sm text-gray-600 mb-4">Mevcut ayarlarla bir test e-postası göndererek yapılandırmanın
                        doğru olduğundan emin olun.</p>
                    <div>
                        ...
                        <input type="email" name="test_email_address" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg" placeholder="test@example.com">
                    </div>
                </div>
