<?php
/**
 * Hakkımızda İçerik Ekleme Sayfası
 * Değer veya Ekip Üyesi Ekleme Formu
 */
...
<div class="space-y-6">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Yeni <?= $section_name ?></h1>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    <div class="p-6 border-b border-gray-100">
                        ...
                        <p class="text-gray-600 text-sm mt-1"><?= $section === 'values' ? 'Değer' : 'Ekip üyesi' ?> bilgilerini girin</p>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-4">
                            ...
                            <div id="icon-preview" class="w-16 h-16 bg-primary-100 rounded-xl flex items-center justify-center">
                                <i id="preview-icon" class="text-primary-600 text-2xl"></i>
                            </div>
                        </div>
