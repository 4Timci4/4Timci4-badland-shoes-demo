 ...
 * Resim Yöneticisi
 * 
 * Resim optimizasyonu, yeniden boyutlandırma, WebP dönüşümü ve lazy loading
 */
...
class ImageManager {
    ...
    /**
     * Boyut hesapla (aspect ratio korunarak)
     */
    ...
    /**
     * Lazy loading JavaScript oluştur
     */
    public function getLazyLoadJS() {
        return "
        <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Intersection Observer desteği varsa
            if ('IntersectionObserver' in window) {
                ...
                // Fallback: Tüm lazy-load resimlerini yükle
                document.querySelectorAll('img.lazy-load').forEach(img => {
                    if (img.dataset.src) {
                        img.src = img.dataset.src;
                        img.classList.remove('lazy-load');
    ...
    /**
     * Disk kullanımını temizle (eski dosyaları sil)
     */
...
/**
 * Global image manager fonksiyonu
 */
