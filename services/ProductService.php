...
class ProductService {
    ...
    public function getProductModels($limit = 10, $offset = 0, $category_slugs = null, $featured = null, $sort = null) {
        ...
        try {
            ...
            return $this->supabase->executeRawSql($sql, $params);
        } catch (Exception $e) {
    ...
    private function getProductModelsWithFallback($limit, $offset, $category_slugs, $featured, $sort) {
        ...
        if (!empty($category_slugs)) {
            ...
            $category_result = $this->supabase->request('/rest/v1/categories?' . http_build_query($category_query));
        ...
        $products = $this->supabase->request('/rest/v1/product_models?' . http_build_query($basic_query));
        ...
        foreach ($products as &$product) {
            ...
            $cat_result = $this->supabase->request('/rest/v1/categories?' . http_build_query($cat_query));
            ...
            $img_result = $this->supabase->request('/rest/v1/product_images?' . http_build_query($img_query));
    ...
    public function getProductModel($model_id) {
        ...
        try {
            $result = $this->supabase->executeRawSql($sql, [':model_id' => $model_id]);
    ...
    private function getProductModelWithFallback($model_id) {
        ...
        $product_result = $this->supabase->request('/rest/v1/product_models?' . http_build_query($query));
        ...
        $image_result = $this->supabase->request('/rest/v1/product_images?' . http_build_query($image_query));
    ...
    public function getProductVariants($model_id) {
        try {
            return $this->supabase->request('/rest/v1/product_variants?model_id=eq.' . $model_id);
        } catch (Exception $e) {
    ...
    public function getProductImages($model_id) {
        try {
            return $this->supabase->request('/rest/v1/product_images?model_id=eq.' . $model_id);
        } catch (Exception $e) {
    ...
    public function getTotalProductCount($category_slugs = null, $featured = null) {
        ...
        try {
            ...
            $result = $this->supabase->request('/rest/v1/product_models_view?' . $queryString);
