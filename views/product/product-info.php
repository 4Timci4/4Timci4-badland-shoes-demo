...
<div class="lg:col-span-2 space-y-5">
    <div>
        <div class="flex items-center justify-between">
            ...
            <a href="/login.php" class="flex items-center justify-center h-10 w-10 rounded-full hover:bg-gray-100 transition-colors duration-200" title="Session kaldırıldı - Favori özelliği çalışmaz">
