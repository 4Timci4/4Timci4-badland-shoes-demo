        ...
        <div class="max-w-7xl mx-auto px-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                <?php foreach ($similar_products as $p): ?>
                    <div
                        class="product-card bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 group h-full flex flex-col">
                        <div class="relative overflow-hidden bg-gray-100 aspect-square">
                            <a href="/product-details?id=<?php echo $p['id']; ?>">
                            ...
                            <div
                                ...
                                <a href="/product-details?id=<?php echo $p['id']; ?>"
                                    ...
                                    title="Ürün Detayı"><i class="fas fa-eye"></i></a>
                            </div>
                        </div>
                        <div class="p-4 text-center flex flex-col flex-grow">
                            <h3 class="text-lg font-medium text-secondary mb-3 min-h-[3.5rem] flex items-center justify-center">
                                <a href="/product-details?id=<?php echo $p['id']; ?>"
                                    class="text-inherit hover:text-primary transition-colors line-clamp-2"><?php echo htmlspecialchars($p['name']); ?></a>
                            </h3>
                        </div>
                    </div>
                <?php endforeach; ?>
