...
<div id="modal-container" class="fixed inset-0 z-50 hidden overflow-y-auto">
  <div class="flex min-h-screen items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
    ...
    <!-- Modal Content -->
    <div id="modal-content" class="inline-block transform overflow-hidden rounded-lg bg-white p-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle">
      <!-- Modal Header -->
      <div class="mb-4 flex items-center justify-between">
        <h3 id="modal-title" class="text-lg font-medium leading-6 text-gray-900"></h3>
        <button id="modal-close" type="button" class="rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none">
...
<script>
  ...
  const modal = {
    ...
    // Uyarı modalı göster (alert yerine)
    ...
    // Onay modalı göster (confirm yerine)
