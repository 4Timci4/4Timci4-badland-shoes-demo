...
// Optimize edilmiş kategori servisini kullan
$optimizedCategoryService = new OptimizedCategoryService();

// Optimize edilmiş hiyerarşik kategori yapısını al (JavaScript için)
$category_hierarchy = $optimizedCategoryService->getCategoriesWithSubcategoriesAndCounts();

// Düz kategori listesi (geriye uyumluluk için)
$all_categories = $optimizedCategoryService->getCategoriesWithProductCountsOptimized();

// Cinsiyetleri getir (cache'lenmiş)
