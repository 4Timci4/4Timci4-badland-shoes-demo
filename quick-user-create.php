<?php
/**
 * Otomatik Hızlı Kullanıcı Oluşturma
 * 
 * Bu betik, çalıştırıldığında otomatik olarak bir test kullanıcısı oluşturur.
 * Test süreçlerini hızlandırmak için tasarlanmıştır.
 */
